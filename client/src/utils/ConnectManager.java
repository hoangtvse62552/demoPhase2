...
//    }
    ...
    public Socket sendRequest(String xmlRq) {
        ...
        try {
            clientSocket = new Socket(ClientConfig.getInstance().getServerIp(),
    ...
    // {
    // InetSocketAddress address = new InetSocketAddress(serverCfg.getServerIp(),
    // serverCfg.getServerPort());
